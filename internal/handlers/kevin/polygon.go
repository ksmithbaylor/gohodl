...
func handlePolygonBridgeOut(bundle handlers.TransactionBundle, client *evm.Client, export handlers.CTCWriter) error {
	...
	if len(netTransfers) != 1 {
		panic("Unexpected net transfers for polygon bridge out")
	}
