...
type Client struct {
	Network core.EvmNetwork // The network the client is for
...
func NewClient(network core.EvmNetwork) (*Client, error) {
...
func (c *Client) Balance(a core.EvmAddress) (core.Amount, error) {
	address := a.ToGeth()
...
func (c *Client) Erc20Decimals(token core.EvmAddress) (uint8, error) {
...
func (c *Client) TokenSymbol(token core.EvmAddress) (string, error) {
...
func (c *Client) Erc20Balance(token core.EvmAddress, a core.EvmAddress) (core.Amount, error) {
